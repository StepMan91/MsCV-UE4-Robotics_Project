...
if("TRUE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /home/bc/ros/indigo/catkin_ws/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /home/bc/ros/indigo/catkin_ws/src/my_pcl_tutorial/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bc <bc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bc/ros/indigo/catkin_ws/src/my_pcl_tutorial/${idir}'.  Ask the maintainer 'bc <bc@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bc/ros/indigo/catkin_ws/src/my_pcl_tutorial/devel/lib;/home/bc/ros/indigo/catkin_ws/devel/lib;/opt/ros/indigo/lib)
